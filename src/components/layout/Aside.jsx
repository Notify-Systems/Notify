    ...
    return (
        <>
            <aside>
                ...
                <AsideButton nome={name[1]} img={`studies`} link="/" select={select === name[1] ? true : false} />
                <AsideButton nome={name[2]} img={`add`} link="/" select={select === name[2] ? true : false} />
                <AsideButton nome={name[3]} img={`eventlist`} link="/" select={select === name[3] ? true : false} />
